...
const MentorIntro = ({ from, to, textColor }) => {
  return (
    <div className='w-screen h-40 xl:h-130 md:h-65 flex justify-center'>
      <div className='w-[94%] h-fit  relative '>
        <div className='w-full h-full flex justify-between ml-[3%]  lg:mt-[6%]'>
          <div className='w-fit  h-fit flex flex-col   '>
            ...
            <h1 className='Alatsi  text-[.8rem] sm:text-2xl lg:text-3xl xl:text-5xl' style={{ color: textColor }}>Mr. Athirupan K. K.</h1>
          </div>
          <div className='w-fit  h-fit flex items-center gap-0.5 px-1 sm:gap-1 sm:px-3 lg:px-6 lg:py-2 rounded-full bg-white/50  z-30 mr-[37%] sm:mr-[35%] mt-4! sm:-mt-[2%] md:mr-[34%] lg:mr-[35%] xs:mr-[38.5%]  '>
            <h1 className='Chivo font-extrabold text-[.5rem] sm:text-xl lg:text-2xl xl:text-4xl md:py-2' style={{ color: textColor }}>20+</h1>
        ...
        <div className='w-full h-full flex justify-between pl-[3%] pb-3! cardstyle relative -mt-[10%]    ' style={{ background: `radial-gradient(at 50% 30%, ${from} 0%, ${to} 100%)` }} >
          <p className='Chivo text-[.3rem] sm:text-[.65rem] lg:text-[.8rem] xl:text-[1rem] relative w-[60%] md:font-light lg:font-normal mt-[19%] md:mt-[14%] leading-1.5 sm:leading-4 lg:leading-5 xl:leading-8'>
            Athirupan K. K., our award-winning mentor, is a visionary leader with over 20 years
          ...
          <div className='w-[40%] h-full flex justify-center relative -bottom-5 right-0 mt-[3%] '>
