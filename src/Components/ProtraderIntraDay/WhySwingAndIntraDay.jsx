...
import SampleImage from '../../assets/WhyAOI_image.png'
        ...
        <div className='w-full h-auto'>
            <div className='w-full h-auto px-4 lg:px-32 py-16 bg-linear-to-br from-[#121108] from-[50%] to-[#988020]  flex flex-col items-center md:gap-24 lg:gap-16' >
                ...
                <div className='w-full h-auto flex flex-col lg:flex-row justify-center items-center  gap-12'>
                    <div className='w-full lg:w-[55%] md:px-12 lg:px-0 h-auto flex flex-col items-center justify-center gap-10 '>
                        <div className='w-full h-auto flex gap-3 md:gap-6 '>
                            <div className='w-fit h-fit '>
                                <p className='Chivo nav-arrow-btn2 text-[1rem] md:text-3xl font-semibold px-2 py-2 rounded-xl! md:px-4 md:py-4'>01</p>
                            </div>
                            <div className='w-full md:w-[88%] h-auto '>
                                <h3 className='Chivo font-semibold text-xl text-nowrap md:text-3xl text-transparent bg-clip-text bg-radial-[at_50%_70%] from-[#FFF3C4] via-[#D5B42D] to-[#FFF3C4] '>Day Trading</h3>
                                <p className='Chivo font-light text-justify md:text-left text-[.7rem] md:text-[1rem] text-white/60'>Day trading involves buying and selling stocks on the same trading day with the goal of
                                    profiting from short-term price changes. Day traders typically use technical analysis,
                        ...
                        <div className='w-full h-auto flex gap-3 md:gap-6 '>
                            <div className='w-fit h-fit '>
                                <p className='Chivo nav-arrow-btn2 text-[1rem] md:text-3xl font-semibold px-2 py-2 rounded-xl! md:px-4 md:py-4'>02</p>
                            </div>
                            <div className='w-full md:w-[88%] h-auto '>
                                <h3 className='Chivo font-semibold text-xl text-nowrap md:text-3xl text-transparent bg-clip-text bg-radial-[at_50%_70%] from-[#FFF3C4] via-[#D5B42D] to-[#FFF3C4] '>Day Trading</h3>
                                <p className='Chivo font-light text-justify md:text-left text-[.7rem] md:text-[1rem] text-white/60'>Day trading involves buying and selling stocks on the same trading day with the goal of
                        ...
                        <div className='w-full h-auto flex gap-3 md:gap-6 '>
                            <div className='w-fit h-fit '>
                                <p className='Chivo nav-arrow-btn2 text-[1rem] md:text-3xl font-semibold px-2 py-2 rounded-xl! md:px-4 md:py-4'>03</p>
                            </div>
                            <div className='w-full md:w-[88%] h-auto '>
                                <h3 className='Chivo font-semibold text-xl text-nowrap md:text-3xl text-transparent bg-clip-text bg-radial-[at_50%_70%] from-[#FFF3C4] via-[#D5B42D] to-[#FFF3C4] '>Day Trading</h3>
                                <p className='Chivo font-light text-justify md:text-left text-[.7rem] md:text-[1rem] text-white/60'>Day trading involves buying and selling stocks on the same trading day with the goal of
                        ...
                        <div className='w-full h-auto flex gap-3 md:gap-6 '>
                            <div className='w-fit h-fit '>
                                <p className='Chivo nav-arrow-btn2 text-[1rem] md:text-3xl font-semibold px-2 py-2 rounded-xl! md:px-4 md:py-4'>04</p>
                            </div>
                            <div className='w-full md:w-[88%] h-auto '>
                                <h3 className='Chivo font-semibold text-xl text-nowrap md:text-3xl text-transparent bg-clip-text bg-radial-[at_50%_70%] from-[#FFF3C4] via-[#D5B42D] to-[#FFF3C4] '>Day Trading</h3>
                                <p className='Chivo font-light text-justify md:text-left text-[.7rem] md:text-[1rem] text-white/60'>Day trading involves buying and selling stocks on the same trading day with the goal of
                        ...
                        <div className='w-full h-auto flex gap-3 md:gap-6 '>
                            <div className='w-fit h-fit '>
                                <p className='Chivo nav-arrow-btn2 text-[1rem] md:text-3xl font-semibold px-2 py-2 rounded-xl! md:px-4 md:py-4'>05</p>
                            </div>
                            <div className='w-full md:w-[88%] h-auto '>
                                <h3 className='Chivo font-semibold text-xl text-nowrap md:text-3xl text-transparent bg-clip-text bg-radial-[at_50%_70%] from-[#FFF3C4] via-[#D5B42D] to-[#FFF3C4] '>Day Trading</h3>
                                <p className='Chivo font-light text-justify md:text-left text-[.7rem] md:text-[1rem] text-white/60'>Day trading involves buying and selling stocks on the same trading day with the goal of
...
export default WhySwingAndIntraDay